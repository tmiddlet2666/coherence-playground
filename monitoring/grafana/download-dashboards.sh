...
set -e
for file in coherence-dashboard-main.json federation-details-dashboard.json http-servers-summary-dashboard.json \
            ...
            persistence-summary-dashboard.json service-details-dashboard.json executors-summary.json executor-details.json cache-store-details-dashboard.json \
