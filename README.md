...
> For the official way of doing setting up Coherence, etc please refer to the [official Coherence commercial documentation](https://docs.oracle.com/en/middleware/standalone/coherence/14.1.1.2206/).
...
1. Setting up of Grafana and Prometheus to monitor Coherence CE
